...
const STABLESWAP_SUBGRAPH_ENDPOINT = 'https://thegraph.blue20bridge.io/subgraphs/name/gsysswap/exchange-stableswap'

const LP_HOLDERS_FEE = 0.0017
const WEEKS_IN_A_YEAR = 52.1429

const BLOCKS_CLIENT_WITH_CHAIN = {
  [ChainId.BSC]: 'https://thegraph.blue20bridge.io/subgraphs/name/gsysswap/bsc-blocks',
  [ChainId.ETHEREUM]: 'https://thegraph.blue20bridge.io/subgraphs/name/blocklytics/ethereum-blocks',
  [ChainId.BSC_TESTNET]: '',
  [ChainId.GOERLI]: '',
  ...
  [ChainId.GSYS]: 'https://thegraph.blue20bridge.io/subgraphs/name/gsysswap/blocks',
}

const INFO_CLIENT_WITH_CHAIN = {
  [ChainId.BSC]: 'https://thegraph.blue20bridge.io/subgraphs/name/exchange-bsc',
  [ChainId.ETHEREUM]: 'https://thegraph.blue20bridge.io/subgraphs/name/gsysswap/exhange-eth',
  [ChainId.BSC_TESTNET]: '',
  [ChainId.GOERLI]: '',
  [ChainId.GSYS]: 'https://thegraph.blue20bridge.io/subgraphs/name/gsysswap/exchange-gsys',
}
