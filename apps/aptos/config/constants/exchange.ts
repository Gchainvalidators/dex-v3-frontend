...
import { APT, CE_USDC, L0_USDC, WH_USDC, BLDT, CE_BNB_MAINNET } from 'config/coins'
...
export const SUGGESTED_BASES: ChainTokenList = {
  [ChainId.MAINNET]: [L0_USDC[ChainId.MAINNET], BLDT[ChainId.MAINNET], CE_BNB_MAINNET],
  [ChainId.TESTNET]: [L0_USDC[ChainId.TESTNET], BLDT[ChainId.TESTNET], CE_BNB_MAINNET],
}
