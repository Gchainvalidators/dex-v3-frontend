  ...
  return (
    <>
      <Head>
        ...
        <meta name="twitter:image" content="https://tempdex.genesys.network/images/hero.png" />
        <meta
        ...
        <meta name="twitter:title" content="🥞 PancakeSwap - A next evolution DeFi exchange on Gchain" />
