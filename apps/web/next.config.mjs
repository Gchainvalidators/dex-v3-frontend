    ...
    remotePatterns: [
      {
        ...
        pathname: '/static-nft.miexs.com/mainnet/**',
      },
    ],
  },
  async rewrites() {
  ...
  async redirects() {
    return [
      ...
      },
      {
        ...
        destination: 'https://bluelotusdaotemp.bluelotusdao.org/api/farms/v3/:chainId/liquidity/:address',
        permanent: false,
      },
      // {
      //   source: '/images/tokens/:address',
      //   destination: 'https://raw.githubusercontent.com/fiwallets/token-list123/gsys/lists/images/gsys/:address',
      //   permanent: false,
      // }
    ]
  },
