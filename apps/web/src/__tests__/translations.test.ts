...
const whitelist = [
  ...
  `Don't let that dopey smile deceive you... Churro's a master BLDT chef!`,
  `Nommm... Oh hi, I'm just meditating on the meaning of BLDT.`,
  `Three guesses what's put that twinkle in those eyes! (Hint: it's BLDT)`,
