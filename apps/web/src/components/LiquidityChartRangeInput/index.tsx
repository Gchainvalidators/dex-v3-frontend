...
import { AutoColumn, BunnyKnownPlaceholder, ChartDisableIcon, LineGraphIcon, LogoRoundIcon, Titi } from '@pancakeswap/uikit'
...
export default function LiquidityChartRangeInput({
  ...
  // Get token color
  const tokenAColor = '#0351EA'
  const tokenBColor = '#0351EA'
  ...
  return (
    <AutoColumn gap="md" style={{ minHeight: '200px', width: '100%', marginBottom: '16px' }}>
      {isUninitialized ? (
        <InfoBox message={t('Your position will appear here.')} icon={<Titi width={'80px'} />} />
      ) : isLoading ? (
