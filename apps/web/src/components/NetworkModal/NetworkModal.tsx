...
import { SUPPORT_ONLY_GSYS } from 'config/constants/supportChains'
...
export const NetworkModal = ({ pageSupportedChains = SUPPORT_ONLY_GSYS }: { pageSupportedChains?: number[] }) => {
