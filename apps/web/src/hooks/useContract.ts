...
export const useCake = () => {
  ...
  return useContract(BLDT[chainId].address ?? BLDT[ChainId.GSYS].address, erc20ABI)
}
...
export const usePredictionsContract = (address: Address, tokenSymbol: string) => {
  ...
  return useMemo(() => {
    ...
    const getPredContract = tokenSymbol === 'BLDT' ? getCakePredictionsContract : getPredictionsV2Contract
