  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Cheaper and faster than Uniswap? Discover BlueLotusDAO Swap, the leading DEX on BNB Smart Chain (BSC) with the best farms in DeFi and a lottery for BLDT."
        />
        <meta name="theme-color" content="#27DBDC" />
