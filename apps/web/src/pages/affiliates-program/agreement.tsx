  ...
  return (
    <AffiliatesProgramLayout>
      <Container>
        ...
        <Text as="p">4.2 All commissions will be paid out in BLDT tokens.</Text>
        <Text as="p">
        ...
        <Text as="p">
          ...
          4.3(a) , we will calculate your commissions in BLDT tokens using the prevailing USD price of BLDT tokens at
          that time.
        </Text>
        ...
        <Text as="p">
          8.3 Any statements you make about BlueLotusDAO Swap must reflect your honest opinions, beliefs, or experiences and
        ...
        <Text as="p">
          14.1 BlueLotusDAO Swap reserves the right to terminate this Agreement in its entirety with or without cause,
        ...
        <Text as="p">
          14.2 BlueLotusDAO Swap, in its sole discretion, reserves the right to suspend or terminate your account and refuse
        ...
        <Text as="p">14.3 BlueLotusDAO Swap reserves the right to refuse service to anyone for any reason at any time.</Text>
