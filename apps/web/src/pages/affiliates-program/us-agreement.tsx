...
const UsAgreement = () => {
  return (
    <AffiliatesProgramLayout>
      <Container>
        <Text as="h1">BlueLotusDAO Swap Affiliate Program Agreement</Text>
        <Text as="h3">Last modified: May 3, 2023</Text>
        <Text as="p">
          This BlueLotusDAO Swap Affiliate Program Agreement (“<strong>Agreement”</strong>) is a legal contract between you (“
          <strong>Affiliate”</strong>) and BlueLotusDAO Swap that applies to your participation in the BlueLotusDAO Swap Affiliate
          Program (“Program”). In this Agreement, “<strong>BlueLotusDAO Swap</strong>,” “<strong>we</strong>” or “
          <strong>us</strong>” means BlueLotusDAO Swap. If you are participating or registering on behalf of a business, then
          ...
          web page), you agree to this Agreement which may be amended from time to time by BlueLotusDAO Swap.
        </Text>
        ...
        <Text as="p">
          ...
          users (“<strong>Referrals”</strong>) to register and trade on BlueLotusDAO Swap, in accordance with the terms of
          this Agreement.
        </Text>
        <Text as="p">
          1.2 A Referral must be a new user and must not have interacted or signed with the BlueLotusDAO Swap platform or used
        ...
        <Text as="p">
          (a) <strong>3</strong>% on trading fees paid by your Referrals on BlueLotusDAO Swap V2 and BlueLotusDAO Swap V3, limited
        ...
        <Text as="p">3.2 All commissions will be paid out in BLDT tokens.</Text>
        <Text as="p">
        ...
        <Text as="p">
          ...
          3.3(a) , we will calculate your commissions in BLDT tokens using the prevailing USD price of BLDT tokens at
          that time.
        </Text>
        <Text as="p">3.4 In calculating your commissions, we reserve the right to determine the:</Text>
        <Text as="p">
          (a) prevailing USD price of the Trading Fees Denomination and the BLDT tokens by reference to the spot price
        ...
        <Text as="p">
          7.3 Any statements you make about BlueLotusDAO Swap must reflect your honest opinions, beliefs, or experiences and
        ...
        <Text as="p">You warrant, represent, and undertake to BlueLotusDAO Swap that:</Text>
        ...
        <Text as="p">
          ...
          not that of employer and employee. You will not be treated as an employee of BlueLotusDAO Swap for any purpose.
          ...
          offers or representations on behalf of BlueLotusDAO Swap. You shall have no authority to bind BlueLotusDAO Swap, and
          undertake not to hold yourself out as an employee, agent or authorised representative of BlueLotusDAO Swap.
        </Text>

        <Text as="h3">12. No Joint Publicity</Text>
        <Text as="p">
          You may not claim that any materials are created jointly between you and BlueLotusDAO Swap, or attribute any
          materials created or issued by you (including press releases) to BlueLotusDAO Swap.
        </Text>

        <Text as="h3">13. Term and Termination</Text>
        <Text as="p">
          13.1 BlueLotusDAO Swap reserves the right to terminate this Agreement in its entirety with or without cause,
          ...
          reason, you shall immediately cease use of (and remove from your site) all links to the BlueLotusDAO Swap website
          and all images of BlueLotusDAO Swap and other materials provided under the Program.
        </Text>
        <Text as="p">
          13.2 BlueLotusDAO Swap, in its sole discretion, reserves the right to suspend or terminate your account and refuse
          any and all current or future use of the Program, or any other BlueLotusDAO Swap service, for any reason and at any
          time. Such termination will result in the deactivation or deletion of your Affiliate Account.
        </Text>
        <Text as="p">13.3 BlueLotusDAO Swap reserves the right to refuse service to anyone for any reason at any time.</Text>

        <Text as="h3">14. Indemnification</Text>
        <Text as="p">
          You shall indemnify BlueLotusDAO Swap from and against all claims, losses, liabilities, damages, administrative
        ...
        <Text as="p">
          BlueLotusDAO Swap and any of BlueLotusDAO Swap&apos;s officers, directors, employees, shareholders or agents of any of
        ...
        <Text as="p">
          ...
          make any price predictions over the BLDT tokens;
        </Text>
        <Text as="p">
        ...
        <Text as="p">
          (e) directing or causing existing users or previous users of BlueLotusDAO Swap Services to create new addresses to
          sign up with your referral link
        </Text>
        <Text as="p">
          (f) Conduct marketing or make any representations of any BlueLotusDAO Swap products and services to users in the
        ...
        <Text as="p">
          BlueLotusDAO Swap may provide you with trademarks and/or graphical images that can be used to promote BlueLotusDAO Swap.
          You may not modify these trademarks and/or images in any way. BlueLotusDAO Swap reserves the right to change the
        ...
        <Text as="p">
          ...
          relationship as an Affiliate which is promoting BlueLotusDAO Swap. For example:
        </Text>
        <Text as="p">
          (a) If you promote BlueLotusDAO Swap through a web page, podcast, blog post, or social media post as an endorsement
          or review of BlueLotusDAO Swap or incentivise others to do so, you must ensure that such post includes a clear
          disclosure that it is an advertisement or was otherwise promoted by BlueLotusDAO Swap; and
        </Text>
        <Text as="p">
        ...
        <Text as="p">
          ...
          Zambia, Zimbabwe (or any additional country or jurisdiction added to this list by BlueLotusDAO Swap from time to
