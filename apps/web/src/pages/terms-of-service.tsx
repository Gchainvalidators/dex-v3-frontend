...
const TermsOfService = () => {
  return (
    <Container>
      <Text as="h1">BlueLotusDAO Swap Terms of Service</Text>
      ...
      <Text as="p">
        ...
        BlueLotusDAO Swap protocol” or the “Protocol”), among other services. The Website is one, but not the exclusive, means
      ...
      <Text as="p">
        ...
        Chain, Aptos and Ethereum. BlueLotusDAO Swap does not control or operate any version of the Protocol on any blockchain
        ...
        BlueLotusDAO Swap team is not a liquidity provider into Protocol liquidity pools and liquidity providers are
      ...
      <Text as="p">
        BlueLotusDAO Swap owns all intellectual property and other rights in the Website and its contents, including (but not
      ...
      <Text as="p">
        ...
        such as rarity scores, token explorer or token lists (which includes the BlueLotusDAO Swap default token list and
        BlueLotusDAO Swap expanded list hosted at tokenlists.org). We may also provide warning labels for certain tokens. The
      ...
      <Text as="p">
        ...
        of any other digital tokens which are transacted on BlueLotusDAO Swap.
      </Text>
      <Text as="p">
      ...
      <Text as="p">
        ...
        modifications to the Protocol are generally managed in a community-driven way by holders of the BLDT token. No
      ...
      <Text as="p">
        ...
        as otherwise expressly set forth in the terms of another offer by BlueLotusDAO Swap, you will be solely responsible to
