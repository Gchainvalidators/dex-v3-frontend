  ...
  return (
    ...
    >
      ...
      <Text textAlign="center" color="textSubtle">
        {t('Together we can make the BlueLotusDAO Swap community even stronger')}
      </Text>
      <Text textAlign="center" color="textSubtle" bold mb="32px">
        {t('How do you Become a BlueLotusDAO Swap Affiliate?')}
      </Text>
        ...
        <Flex width={['100%', '100%', '100%', '33.33%']}>
          <Card>
            <Box padding={['24px']}>
              ...
              <Text fontSize={['14px']} mt="24px">
                {t('Earn up to 20% referral commissions in BLDT')}
              </Text>
            </Box>
          </Card>
        </Flex>
