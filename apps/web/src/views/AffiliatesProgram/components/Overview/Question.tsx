    ...
    >
      <Wrapper>
        ...
        <Card>
          ...
          <StyledCardBody>
            <FoldableText title={t('What is the criteria to become a BlueLotusDAO Swap affiliate?')} mt="24px">
              ...
              <StyledListText color="textSubtle">
                {t('Strong understanding of BlueLotusDAO Swap and our ecosystem')}
              </StyledListText>
            </FoldableText>
