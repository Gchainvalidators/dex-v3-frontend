...
const { farmV3MigrationBunny, farmV3MigrationMobileBunny } = {
  farmV3MigrationBunny: `/images/banners/farmV3MigrationBunny.png`,
  farmV3MigrationMobileBunny: `/images/banners/farmV3MigrationMobileBunny.png`,
}
      ...
      <S.Inner>
        <S.LeftWrapper>
          <Flex flexDirection={['column', 'row']} mb={['8px', '8px', '12px']}>
            ...
            <Title>{isMobile ? t('BLDT v3 Migration') : t('BlueLotusDAO v3 Migration')}</Title>
          </Flex>
          <StyledBox>{t('Migrate to continue farming BLDT rewards and earning trading fees.')}</StyledBox>
