...
const { pancakeProtectorBunny, pancakeProtectorBgMobile, pancakeProtectorBg, pancakeSwapLogo } = {
  pancakeSwapLogo: `/images/banners/ethXpancakeswap.png`,
  pancakeProtectorBunny: `/images/banners/pancakeProtectorBunny.png`,
  pancakeProtectorBg: `/images/banners/pancakeProtectorBg.png`,
  pancakeProtectorBgMobile: `/images/banners/pancakeProtectorBgMobile.png`,
}
    ...
    >
      <S.Inner>
        <S.LeftWrapper position="relative" style={{ zIndex: 2 }}>
          ...
          <StyledSubheading>{isDesktop && t('Exclusive Perks for BlueLotusDAO Swap Bunnies and Squads')}</StyledSubheading>
