...
const { v3LaunchBg, v3LaunchBgMobile, v3LaunchBunny, v3LaunchBunnyMobile, v3LaunchBnb, v3LaunchEth, v3LaunchFlag } = {
  v3LaunchBg: `/images/banners/v3LaunchBg.png`,
  v3LaunchBgMobile: `/images/banners/v3LaunchBgMobile.png`,
  v3LaunchBunny: `/images/banners/v3LaunchBunny.png`,
  v3LaunchBunnyMobile: `/images/banners/v3LaunchBunnyMobile.png`,
  v3LaunchBnb: `/images/banners/v3LaunchBnb.png`,
  v3LaunchEth: `/images/banners/v3LaunchEth.png`,
  v3LaunchFlag: `/images/banners/v3LaunchFlag.png`,
}
        ...
        <S.LeftWrapper style={{ zIndex: 2 }}>
          <TextBox>
            ...
            <TitleWrapper alignItems="center" style={{ gap: 5 }}>
              <LogoIcon /> <Title>{t('BlueLotusDAO Swap v3 is live!')}</Title>
            </TitleWrapper>
          </TextBox>
          <NextLinkFromReactRouter
            target="_blank"
