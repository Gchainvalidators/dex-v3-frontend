...
const SalesSection: React.FC<React.PropsWithChildren<SalesSectionProps>> = (props) => {
  const { headingText, colorHeadingText, firstColorText, bodyText, reverse, primaryButton, secondaryButton, images } = props
    ...
    <Flex flexDirection="column">
      ...
      >
        ...
        >
          ...
          />
          <Text color={colorHeadingText ? colorHeadingText : 'text'} mb="24px">
            {bodyText}
          </Text>
          <Flex>
            <Button mr="16px">
