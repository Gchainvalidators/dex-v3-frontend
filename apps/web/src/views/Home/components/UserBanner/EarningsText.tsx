...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and BLDT pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and BLDT pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from BLDT pool', data)
  }
