...
const LotteryCardContent = () => {
  ...
  const cakePrizesText = t('%cakePrizeInUsd% in BLDT prizes this round', { cakePrizeInUsd: cakePriceBusd.toString() })
    ...
    <>
      <Flex flexDirection="column" mt="48px">
        ...
        {currentLotteryPrize && currentLotteryPrize.gt(0) ? (
          ...
          <>
            <Skeleton width={200} height={40} my="8px" style={{background: '#ffffff'}} />
            <div ref={observerRef} />
          </>
        )}
        ...
        <Text color="white" mb="40px">
          {t('Buy tickets with BLDT, win BLDT if your numbers match')}
        </Text>
      </Flex>
