...
const PredictionCardContent = () => {
  ...
  const bnbWonText = t('$%wonInUsd% in GSYS + BLDT won so far', { wonInUsd: localisedBnbUsdString })
  ...
  return (
    <>
      <Flex flexDirection="column" mt="48px">
        <Text color="#000000" bold fontSize="16px">
          {t('Prediction')}
        </Text>
        {bnbWonInUsd ? (
        ...
        <Text color="#000000" mb="24px" bold fontSize="16px">
          {wonSoFar}
        </Text>
        <Text color="#000000" mb="40px">
          {t('Predict the price trend of GSYS or BLDT to win')}
        </Text>
      </Flex>
