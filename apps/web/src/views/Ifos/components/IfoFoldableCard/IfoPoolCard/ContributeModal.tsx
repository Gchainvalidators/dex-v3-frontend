...
const ContributeModal: React.FC<React.PropsWithChildren<Props>> = ({
  ...
  const label = currency === bscTokens.bldt ? t('Max. BLDT entry') : t('Max. token entry')
      ...
      <ModalBody maxWidth="360px">
        <Box p="2px">
          ...
          <Text color="textSubtle" fontSize="12px" mb="24px">
            {t(
              'If you don’t commit enough BLDT, you may not receive a meaningful amount of IFO tokens, or you may not receive any IFO tokens at all.',
            )}
            <Link
              fontSize="12px"
              display="inline"
