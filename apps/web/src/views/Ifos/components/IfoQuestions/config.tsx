...
const config = [
  {
    ...
    description: [
      <Trans>
        ...
        BLDT up to the maximum commit limit, which is published along with the IFO voting proposal. The Private Sale has
        no participation fee.
      </Trans>,
      <Trans>
        In the Public Sale, everyone with an active BlueLotusDAO Swap profile can commit. However the maximum amount of BLDT
  ...
  },
  {
    ...
    description: [
      ...
      <Trans>Just remember you need an active BlueLotusDAO Swap Profile in order to participate.</Trans>,
    ],
  },
  {
  ...
  },
  {
    ...
    description: [<Trans>The BLDT from the participation fee will be burnt as part of the weekly token burn.</Trans>],
  },
  {
    title: <Trans>How can I get an achievement for participating in the IFO?</Trans>,
    description: [
      <Trans>You need to contribute a minimum of about 10 USD worth of BLDT to either sale.</Trans>,
      <Trans>
