  ...
  return (
    <CardBody>
      ...
      <Heading as="h4" color="secondary" mb="16px">
        {t('Lock BLDT in the BLDT pool')}
      </Heading>
      <Box>
        <Text mb="4px" color="textSubtle" small>
          {t(
            'The maximum amount of BLDT you can commit to the Public Sale equals the number of your iCAKE. Lock more BLDT for longer durations to increase the maximum BLDT you can commit to the sale.',
          )}
        </Text>
  ...
  return (
    <CardBody>
      ...
      <Text color="textSubtle" small>
        {t(
          'Please note that BLDT in the fixed-term staking positions will remain locked and can not be used for committing to IFO sales. You will need a separate amount of BLDT in your wallet balance to commit to the IFO sales.',
        )}{' '}
        <br />
      </Text>
        ...
        return (
          <CardBody>
            ...
            <Text color="textSubtle" small mb="16px">
              {t('You’ll need an active BlueLotusDAO Swap Profile to take part in an IFO!')}
            </Text>
            {renderAccountStatus()}
          </CardBody>
        )
      ...
      case 3:
        return (
          <CardBody>
            ...
            <Text color="textSubtle" small>
              {t(
                'After the IFO sales finish, you can claim any IFO tokens that you bought, and any unspent BLDT tokens will be returned to your wallet.',
              )}
            </Text>
          </CardBody>
        )
