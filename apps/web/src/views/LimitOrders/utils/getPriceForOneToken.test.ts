...
const BLDT = new ERC20Token(56, '0x7E9808c731ce79B2DfC18B88e3Baad3D115DB102', 18, 'BLDT', 'BlueLotusDAO')
...
describe('limitOrders/utils/getPriceForOneToken', () => {
  describe.each([
    [CurrencyAmount.fromRawAmount(BLDT, ONE), CurrencyAmount.fromRawAmount(BUSD, ONE), '1'],
    [CurrencyAmount.fromRawAmount(BLDT, FIVE), CurrencyAmount.fromRawAmount(BUSD, FIVE), '1'],
    [CurrencyAmount.fromRawAmount(BLDT, ONE), CurrencyAmount.fromRawAmount(BUSD, FIVE), '5'],
    [CurrencyAmount.fromRawAmount(BLDT, FIVE), CurrencyAmount.fromRawAmount(BUSD, ONE), '0.2'],
    ...
    [CurrencyAmount.fromRawAmount(BLDT, ZERO), CurrencyAmount.fromRawAmount(BUSD, ONE), undefined],
    [CurrencyAmount.fromRawAmount(BLDT, ONE), CurrencyAmount.fromRawAmount(BUSD, ZERO), undefined],
