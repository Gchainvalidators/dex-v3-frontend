...
export const TEXT = {
  v2: {
    ...
    steps: [
      {
        title: <Trans>Unstaking LP Tokens and BLDT</Trans>,
        subTitle: <Trans>All the earned BLDT will be harvested to your wallet upon unstake.</Trans>,
  ...
  v3: {
    title: <Trans>BlueLotusDAO Swap v3 Migration</Trans>,
    steps: [
      {
      ...
      },
      {
        ...
        subTitle: <Trans>Start earning BLDT by staking your liquidity positions to V3 Farms!</Trans>,
