...
const MOCK_TOKENS = {
  [ChainId.BSC]: [bscTokens.bldt, bscTokens.wbnb],
  ...
  return (
    <AtomBox textAlign="center">
      <Heading scale="lg" pb="16px">
        {t('Quick Start')} - {t('BlueLotusDAO Swap V3')}
      </Heading>
      <Text pb="48px">
        {t(
          'In BlueLotusDAO Swap Exchange V3, liquidity providers are able to customize the trading fee tier and concentrate their liquidity to a specific price range to maximize their capital efficiency.',
        )}
      </Text>
