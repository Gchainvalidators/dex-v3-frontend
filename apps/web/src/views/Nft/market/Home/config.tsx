  ...
  return [
    {
      ...
      description: [
        ...
        t('You can instantly swap your WBNB for BNB with no trading fees on BlueLotusDAO Swap.'),
      ],
    },
    {
    ...
    },
    {
      ...
      description: [
        t(
          '100% of all platform fees taken by BlueLotusDAO Swap from sales are used to buy back and BURN BLDT tokens in our weekly BLDT burns.',
        ),
        t(
          'Platform fees: 2% is subtracted from NFT sales on the market. Subject to change.Collection fees: Additional fees may be taken by collection creators, once those collections are live. These will not contribute to the BLDT burns.',
        ),
      ],
    },
  ]
