  ...
  return [
    {
      ...
      bodyText: [t('You’ll need an active BlueLotusDAO Swap Profile to buy Minting Tickets and mint a Pancake Squad NFT!')],
      buttons: (
        <>
    ...
    },
    {
      ...
      title: t('Hold BLDT'),
      bodyText: [t('Each NFT costs BLDT to mint. Remember you also need BNB to cover transaction fees too!')],
      buttons: (
        <>
          <Button
            as="a"
