...
import { Box, Flex, lightColors, Spinner, Text, Timeline, Titi } from '@pancakeswap/uikit'
  ...
  return (
    ...
    >
      ...
      <Text color={lightColors.invertedContrast} textAlign="center">
        {t('BlueLotusDAO Swap’s first official generative NFT collection.')}
      </Text>
          ...
          <StyledSquadEventContainer m="1px" p="32px">
            <Flex flexDirection={['column', null, 'row']}>
              ...
              <Flex flexDirection="column">
                ...
                {isLoading && (userStatus === UserStatusEnum.UNCONNECTED ? <ConnectWalletButton /> : <Titi />)}
              </Flex>
            </Flex>
          </StyledSquadEventContainer>
        </StyledSquadEventBorder>
