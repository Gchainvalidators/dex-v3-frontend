...
const ButtonMenu: React.FC<React.PropsWithChildren<ButtonMenuProps>> = ({
  ...
  const { targetRef, tooltip, tooltipVisible } = useTooltip(
    t(
      'Your chance of winning is proportional to the BLDT you deposit relative to the total BLDT deposit for Pottery. Currently, there is a cap to the total BLDT deposit size during the beta release.',
    ),
    {
      placement: 'top-end',
      tooltipOffset: [20, 10],
