...
const SetPositionCard: React.FC<React.PropsWithChildren<SetPositionCardProps>> = ({
  ...
  const { setLastUpdated, allowance } = useCakeApprovalStatus(token.symbol === 'BLDT' ? predictionsAddress : null)
  ...
  const handleEnterPosition = async () => {
    ...
    const args = token.symbol === 'BLDT' ? [epoch, valueAsBn.toString()] : [epoch]
