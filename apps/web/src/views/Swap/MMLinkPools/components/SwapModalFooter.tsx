            ...
            <QuestionHelper
              text={
                <>
                  ...
                  <Text>- {t('%amount% towards BLDT buyback and burn', { amount: buyBackFeePercent })}</Text>
                  <Text mt="12px">
                  ...
                  <Text mt="10px">
                    ...
                    :{' '}
                    {t(
                      'BlueLotusDAO Swap does not charge any fees for trades. However, the market makers charge an implied fee of 0.05% - 0.25% (non-stablecoin) / 0.01% (stablecoin) factored into the quotes provided by them.',
                    )}
                  </Text>
                </>
              }
