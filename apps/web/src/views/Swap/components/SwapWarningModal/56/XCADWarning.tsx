  ...
  return (
    <Box maxWidth="380px">
      <Text>
        ...
        <br />
        {t(
          'You can obtain the new token either by swapping your old tokens on BlueLotusDAO Swap or bridging them to ETH and back to BSC using the new bridge provider.',
        )}
        <br />
