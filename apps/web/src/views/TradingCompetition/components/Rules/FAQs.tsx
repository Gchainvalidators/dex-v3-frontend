        ...
        <StyledCardbody>
          <FoldableText title={t('Eligible trading pairs')} mt="24px">
            <Text fontSize="14px" color="textSubtle">
              {t(
                'Only trades on DAR/BNB, BLDT/BNB, and BLDT/BUSD pairs will be included in volume calculations. Please note that the volume from limit orders will not be included.',
              )}
            </Text>
          </FoldableText>
          ...
          <FoldableText title={t('Prize distribution')} mt="24px">
            <Text fontSize="14px" color="textSubtle">
              -{' '}
              {t(
                'Prizes to be distributed in BLDT and DAR in a distribution of 1:5 and shared by all members of each respective tier.',
              )}
            </Text>
            <Text fontSize="14px" color="textSubtle">
              -{' '}
              {t(
                'The price of token prizes ($BLDT and $DAR) in USD will be determined as per their BUSD pair price during the tally period.',
              )}
            </Text>
            <Text fontSize="14px" color="textSubtle">
          ...
          <FoldableText title={t('Fine print')} mt="24px">
            <Text fontSize="14px" color="textSubtle">
              -{' '}
              {t(
                'In the event of a disagreement concerning the final winning team or rank, BlueLotusDAO Swap will have the final say.',
              )}
            </Text>
            <Text fontSize="14px" color="textSubtle">
              -{' '}
              {t(
                'BlueLotusDAO Swap can and will disqualify any team or specific members that are proven to have taken malicious action or attempt to “cheat” in any way.',
              )}
            </Text>
          </FoldableText>
