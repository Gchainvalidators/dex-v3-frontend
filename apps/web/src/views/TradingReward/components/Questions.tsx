        ...
        <Card style={{ width: '100%' }}>
          <StyledCardBody>
            ...
            >
              <StyledListText color="textSubtle">
                {t(
                  'Each campaign has its own eligibility requirements, like the unlock time of the BLDT staking position.',
                )}
              </StyledListText>
              <StyledListText color="textSubtle">
                {t(
                  'You may need to extend your locked BLDT staking position. Please follow the instructions on the page.',
                )}
              </StyledListText>
            </FoldableText>
          </StyledCardBody>
