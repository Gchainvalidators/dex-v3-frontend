  ...
  return (
    <>
      <GreyCard>
        ...
        <Text fontSize="14px" color="textSubtle">{`~${formatNumber(rewardInCake)} BLDT`}</Text>
        ...
        {additionalAmount >= 0.01 && (
          <Message variant="warning" mt="10px">
            <MessageText>
              ...
              <Text as="span" bold>
                {t('Lock more BLDT to keep earning.')}
              </Text>
            </MessageText>
          </Message>
        )}
      ...
      {additionalAmount >= 0.01 && (
        <GreyCard mt="24px">
          ...
          <Text color="failure" fontSize="14px">{`~${formatNumber(maxRewardCapCakePrice)} BLDT`}</Text>
          <Text width="100%" lineHeight="120%">
            <Text color="textSubtle" fontSize="14px" lineHeight="120%" as="span">
              {t('Equals to your %amount%% of locked BLDT divided by', { amount: maxRewardCapInfoAmount })}
            </Text>
            <Text color="textSubtle" fontSize="14px" lineHeight="120%" as="span" ml="4px">
              {t('of the amount of your locked BLDT. Lock more BLDT to raise this limit')}
            </Text>
          </Text>
          {additionalAmount >= 0.01 && (
            <AddCakeButton
