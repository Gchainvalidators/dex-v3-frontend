...
Use BSC as an example. Here's how we use smart router sdk to find the best trade route swapping from BNB to BLDT and construct a valid swap transaction from the trade route we got.
...
const v3SubgraphClient = new GraphQLClient('https://thegraph.blue20bridge.io/subgraphs/name/gsysswap/exchange-v3-bsc')
