...
export const MIXED_ROUTE_QUOTER_ADDRESSES = {
  ...
  [ChainId.BSC]: '0x4e55C073f185e51474A251c327D7245a34ba69c1',
  ...
  // [ChainId.GSYS]: '0xd6c5832D53461Ab72179ad61a12C436EE9C79bb4',
  [ChainId.GSYS]: '0xdF1F5b4472c1FCaFa0ecc1661e5B2539402BD4E5',
...
export const V3_QUOTER_ADDRESSES = {
  ...
  [ChainId.BSC]: '0xEB8c164572aA79a386a155f275CB22B68ef1B18F',
  ...
  // [ChainId.GSYS]: '0xC32114626A36A7EA8ECB4D70e289D624e671B3F4',
  [ChainId.GSYS]: '0xC32114626A36A7EA8ECB4D70e289D624e671B3F4',
} as const satisfies Record<ChainId, Address>
