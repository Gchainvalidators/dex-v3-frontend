...
export const FACTORY_ADDRESS = '0xB6517cBCd442A31C6E3E1bcb7C18c8a4FC385e2f'
export const FACTORY_ADDRESS_GSYS = '0x5c4619104985163b3839dA465232B6D2a9588E7B' // FactoryV2
...
export const FACTORY_ADDRESS_MAP = {
  ...
  [ChainId.GSYS]: FACTORY_ADDRESS_GSYS,
} as const satisfies Record<ChainId, Address>

export const INIT_CODE_HASH = '0x00fb7f630766e6a796048ea87d01acd3068e8ff67d078148a3fa3f4a84f69bd5'
export const INIT_CODE_HASH_GSYS = '0xc2bfaff4ea17452e36160a6b52d17dc3d4dd3fe838e185e0acd70e71d05803e8'

const INIT_CODE_HASH_ETH = '0x57224589c67f3f30a6b0d7a1b54cf3153ab84563bc609ef41dfb34f8b2974d2d'
export const INIT_CODE_HASH_MAP = {
  [ChainId.ETHEREUM]: INIT_CODE_HASH_ETH,
  [ChainId.GOERLI]: INIT_CODE_HASH_ETH,
  [ChainId.BSC]: INIT_CODE_HASH_GSYS,
  ...
  [ChainId.GSYS]: INIT_CODE_HASH_GSYS,
...
export const WETH9 = {
  ...
  [ChainId.GSYS]: new ERC20Token(
    ChainId.GSYS,
    '0xb5a3137bb79EBE487f2d2Ee3db388B415Cd01D2b',
    18,
    'WETH',
    'Wrapped Ether',
    'https://weth.io'
...
export const WNATIVE = {
  [ChainId.GSYS]: WGSYS[ChainId.GSYS],
...
const GSYS = { name: 'Genesys Mainnet', symbol: 'GSYS', decimals: 18 } as const
