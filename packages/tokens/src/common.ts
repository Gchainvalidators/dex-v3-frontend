...
export const CAKE_GSYS = new ERC20Token(
  ChainId.GSYS,
...
export const USDC_GSYS = new ERC20Token(
  ChainId.GSYS,
...
export const USDT_GSYS = new ERC20Token(
  ChainId.GSYS,
  '0x766C8AeD079D43D6B29dA8792b818373b933d80e',
  18,
  'USDT',
  'Tether USD from Blue20',
  'https://tether.to/',
)
...
// export const BUSD_GSYS = new ERC20Token(
//   ChainId.GSYS,
//   '0xfddaEc48aCa60294f814aB0cAc718491B3F64DDb',
//   18,
//   'BUSD',
//   'Binance USD',
...
export const WBTC_GSYS = new ERC20Token(
  ChainId.GSYS,
  '0xd4B07609A5A9B6640024Dbd401c4Fd9AF5b6A7f6',
  8,
  'WBTC',
  'Wrapped BTC',
)
